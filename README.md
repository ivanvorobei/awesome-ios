...
### Activity Indicator
A view that shows that a task is in progress [•](https://awesome-ios.com/activity-indicator)
...
### Action Sheet
An action sheet is a specific style of alert that presents two or more choices related to the current context [•](https://awesome-ios.com/action-sheet)
...
### Alert
Alerts convey important information related to the state of your app or the device, and often request feedback [•](https://awesome-ios.com/alert)
...
### Transition
List of animation transitions [•](https://awesome-ios.com/animation/transition)
...
### Calendar
List of components and ready-use calendars [•](https://awesome-ios.com/calendar)
...
### Cards
List of cards [•](https://awesome-ios.com/cards)
...
### Button
A control that executes your custom code in response to user interactions [•](https://awesome-ios.com/control/button)
...
### Segment Control
A control that consists of multiple segments, each segment functioning as a discrete button [•](https://awesome-ios.com/control/segmented-control)
...
### Slider
A control for selecting a single value from a continuous range of values [•](https://awesome-ios.com/control/slider)
...
### Switch
A control that offers a binary choice, such as on/off [•](https://awesome-ios.com/control/switch)
...
### Text Field
An object that displays an editable text area in your interface [•](https://awesome-ios.com/control/text-field)
...
### Text View
A scrollable, multiline text region [•](https://awesome-ios.com/control/text-view)
...
### Collection View
An object that manages an ordered collection of data items and presents them using customizable layouts [•](https://awesome-ios.com/collection-view)
...
### Controller
An object that manages a view hierarchy for your UIKit app [•](https://awesome-ios.com/controller)
...
### Label
A view that displays one or more lines of informational text [•](https://awesome-ios.com/label)
...
### Menu
List of menus [•](https://awesome-ios.com/menu)
...
### Tab Bar
A control that displays one or more buttons in a tab bar for selecting between different subtasks, views, or modes in an app [•](https://awesome-ios.com/tab-bar)
...
### Table View
A view that presents data using rows in a single column [•](https://awesome-ios.com/table-view)
